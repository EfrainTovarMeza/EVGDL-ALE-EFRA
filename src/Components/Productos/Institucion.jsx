    ...
    return (
        <>
         <div className="slide">
            ...
            <p className="textslide">Tenemos la solución en productos biodegradables para tu Institucion</p>
        </div>
        <div className="baner">
            <p>PRODUCTOS BIODEGRADABLES PARA TU INSTITUCION LISTOS PARA USARSE Y CONCENTRADOS</p>
        </div>
